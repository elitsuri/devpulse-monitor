...
app = FastAPI(
    title="DevPulse Monitor",
    description="Developer productivity monitor with git stats and time tracking",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "DevPulse Monitor"}
